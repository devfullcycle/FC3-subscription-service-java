...
import com.fullcycle.codeflix.subscription.infrastructure.repositories.SubscriptionRepository;
...
public class SubscriptionRepositoryAdapter implements SubscriptionGateway {
    ...
    @Override
    public Optional<Subscription> latestSubscriptionOfUser(UserId userId) {
        return Optional.empty();
    }
